...
public abstract class ProjectileEntity extends Entity
{
    ...
    public Entity func_234616_v_()
    {
        ...
        {
            Entity byId = this.world.getEntityByID(this.field_234610_c_);
            if (byId != null)
            {
                this.shooter = byId;
                return byId;
        ...
        {
            Entity byUuid = ((ServerWorld) this.world).getEntityByUuid(this.field_234609_b_);
            if (byUuid != null)
            {
                this.shooter = byUuid;
                return byUuid;
