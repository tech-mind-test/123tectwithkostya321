...
public abstract class LivingEntity extends Entity {
    ...
    public final TimeUtil lastSwing = new TimeUtil();
    ...
    public void onDeath(DamageSource cause)
    {
        if (!this.removed && !this.dead)
        {
            ...
            EventManager.call(new EventEffectKill(this,cause));
    ...
    public Vector3d getRotationVector() {
        return this.getRotationVector(this.rotationPitch, this.rotationYaw);
    }
    public final Vector3d getRotationVector(float pitch, float yaw) {
