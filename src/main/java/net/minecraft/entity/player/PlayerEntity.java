...
import sky.core.events.EventCriticalHit;
import sky.core.events.EventGetDigSpeed;
...
import sky.core.events.EventSwimming;
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            if (autoSprint != null && autoSprint.isEnabled()) {
                                if (!autoSprint.getWeatetr().get() && !(this instanceof ClientPlayerEntity) && !isInWater()) {
                                    this.setSprinting(false);
                                }
                            } else if (!(this instanceof ClientPlayerEntity) && !isInWater()) {
                                this.setSprinting(false);
                            }
...
//            double d3 = this.getLookVec().y;
            ...
            double d3 = this.getVectorForRotation(eventSwimming.getPitch(), eventSwimming.getYaw()).y;
