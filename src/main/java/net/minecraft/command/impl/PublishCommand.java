...
public class PublishCommand
{
    ...
    {
        return new TranslationTextComponent("cmd.publish.alreadyPublished", p_208900_0_);
    });
    ...
    private static int publish(CommandSource source, int port) throws CommandSyntaxException
    {
        ...
        {
            source.sendFeedback(new TranslationTextComponent("cmd.publish.success", port), true);
            return port;
        }
    }
}
