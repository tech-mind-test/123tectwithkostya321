...
{
    private static final SimpleCommandExceptionType field_229824_a_ = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.spectate.self"));
    private static final DynamicCommandExceptionType field_229825_b_ = new DynamicCommandExceptionType((p_229830_0_) ->
    {
        return new TranslationTextComponent("cmd.spectate.not_spectator", p_229830_0_);
    });
    ...
    private static int func_229829_a_(CommandSource p_229829_0_, @Nullable Entity p_229829_1_, ServerPlayerEntity p_229829_2_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            if (p_229829_1_ != null)
            {
                p_229829_0_.sendFeedback(new TranslationTextComponent("cmd.spectate.success.started", p_229829_1_.getDisplayName()), false);
            }
            else
            {
                p_229829_0_.sendFeedback(new TranslationTextComponent("cmd.spectate.success.stopped"), false);
            }
