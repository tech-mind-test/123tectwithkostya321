...
public class SummonCommand
{
    ...
    private static final SimpleCommandExceptionType field_244378_b = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.summon.failed.uuid"));
    private static final SimpleCommandExceptionType field_241075_b_ = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.summon.invalidPosition"));
