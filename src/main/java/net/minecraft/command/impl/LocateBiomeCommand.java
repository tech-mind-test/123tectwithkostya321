...
public class LocateBiomeCommand
{
    ...
    {
        return new TranslationTextComponent("cmd.locatebiome.invalid", p_241052_0_);
    });
    private static final DynamicCommandExceptionType field_241045_b_ = new DynamicCommandExceptionType((p_241050_0_) ->
    {
        return new TranslationTextComponent("cmd.locatebiome.notFound", p_241050_0_);
    });
    ...
    private static int func_241049_a_(CommandSource p_241049_0_, ResourceLocation p_241049_1_) throws CommandSyntaxException
    {
        ...
        {
            return LocateCommand.func_241054_a_(p_241049_0_, s, blockpos, blockpos1, "cmd.locatebiome.success");
        }
    }
}
