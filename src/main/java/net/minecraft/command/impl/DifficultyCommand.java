...
public class DifficultyCommand
{
    ...
    {
        return new TranslationTextComponent("cmd.difficulty.failure", p_208823_0_);
    });
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher)
    {
        ...
        }).executes((p_198346_0_) ->
        {
            ...
            p_198346_0_.getSource().sendFeedback(new TranslationTextComponent("cmd.difficulty.query", difficulty1.getDisplayName()), false);
