...
public class ExecuteCommand
{
    ...
    {
        return new TranslationTextComponent("cmd.execute.blocks.toobig", p_208885_0_, p_208885_1_);
    });
    private static final SimpleCommandExceptionType TEST_FAILED = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.execute.conditional.fail"));
    private static final DynamicCommandExceptionType TEST_FAILED_COUNT = new DynamicCommandExceptionType((p_210446_0_) ->
    {
        return new TranslationTextComponent("cmd.execute.conditional.fail_count", p_210446_0_);
    });
    ...
    private static Command<CommandSource> func_218834_a(boolean p_218834_0_, ExecuteCommand.INumericTest p_218834_1_)
    {
        return p_218834_0_ ? (p_229783_1_) ->
        {
            ...
            if (i > 0)
            {
                p_229783_1_.getSource().sendFeedback(new TranslationTextComponent("cmd.execute.conditional.pass_count", i), false);
                return i;
            }
            else {
        ...
        } : (p_229771_1_) ->
        {
            ...
            if (i == 0)
            {
                p_229771_1_.getSource().sendFeedback(new TranslationTextComponent("cmd.execute.conditional.pass"), false);
                return 1;
            }
            else {
    ...
    private static ArgumentBuilder < CommandSource, ? > buildIfResult(CommandNode<CommandSource> context, ArgumentBuilder < CommandSource, ? > builder, boolean value, ExecuteCommand.IBooleanTest test)
    {
        ...
        }).executes((p_229776_2_) ->
        {
            ...
            {
                p_229776_2_.getSource().sendFeedback(new TranslationTextComponent("cmd.execute.conditional.pass"), false);
                return 1;
            }
            else {
                throw TEST_FAILED.create();
    ...
    private static int checkBlockCountIf(CommandContext<CommandSource> context, boolean isMasked) throws CommandSyntaxException
    {
        ...
        {
            context.getSource().sendFeedback(new TranslationTextComponent("cmd.execute.conditional.pass_count", optionalint.getAsInt()), false);
    ...
    private static int checkBlockCountUnless(CommandContext<CommandSource> context, boolean isMasked) throws CommandSyntaxException
    {
        ...
        {
            context.getSource().sendFeedback(new TranslationTextComponent("cmd.execute.conditional.pass"), false);
            return 1;
        }
    }
