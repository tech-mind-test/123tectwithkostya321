...
public class WeatherCommand
{
    ...
    private static int setClear(CommandSource source, int time)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.weather.set.clear"), true);
        return time;
    }
    ...
    private static int setRain(CommandSource source, int time)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.weather.set.rain"), true);
        return time;
    }
    ...
    private static int setThunder(CommandSource source, int time)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.weather.set.thunder"), true);
        return time;
    }
}
