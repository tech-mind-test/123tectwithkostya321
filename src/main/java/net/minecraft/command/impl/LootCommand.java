...
public class LootCommand
{
    ...
    {
        return new TranslationTextComponent("cmd.drop.no_held_items", p_218896_0_);
    });
    private static final DynamicCommandExceptionType field_218906_c = new DynamicCommandExceptionType((p_218889_0_) ->
    {
        return new TranslationTextComponent("cmd.drop.no_loot_table", p_218889_0_);
    });
    ...
    private static void func_218875_a(CommandSource p_218875_0_, List<ItemStack> p_218875_1_)
    {
        if (p_218875_1_.size() == 1)
        {
            ...
            p_218875_0_.sendFeedback(new TranslationTextComponent("cmd.drop.success.single", itemstack.getCount(), itemstack.getTextComponent()), false);
        }
        else
        {
            p_218875_0_.sendFeedback(new TranslationTextComponent("cmd.drop.success.multiple", p_218875_1_.size()), false);
        }
    }
    ...
    private static void func_218860_a(CommandSource p_218860_0_, List<ItemStack> p_218860_1_, ResourceLocation p_218860_2_)
    {
        if (p_218860_1_.size() == 1)
        {
            ...
            p_218860_0_.sendFeedback(new TranslationTextComponent("cmd.drop.success.single_with_table", itemstack.getCount(), itemstack.getTextComponent(), p_218860_2_), false);
        }
        else
        {
            p_218860_0_.sendFeedback(new TranslationTextComponent("cmd.drop.success.multiple_with_table", p_218860_1_.size(), p_218860_2_), false);
        }
    }
