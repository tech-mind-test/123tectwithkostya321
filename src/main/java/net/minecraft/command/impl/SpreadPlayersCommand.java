...
public class SpreadPlayersCommand
{
    ...
    {
        return new TranslationTextComponent("cmd.spreadplayers.failed.teams", p_208910_0_, p_208910_1_, p_208910_2_, p_208910_3_);
    });
    ...
    {
        return new TranslationTextComponent("cmd.spreadplayers.failed.entities", p_208912_0_, p_208912_1_, p_208912_2_, p_208912_3_);
    });
    ...
    private static int func_241070_a_(CommandSource p_241070_0_, Vector2f p_241070_1_, float p_241070_2_, float p_241070_3_, int p_241070_4_, boolean p_241070_5_, Collection <? extends Entity > p_241070_6_) throws CommandSyntaxException
    {
        ...
        p_241070_0_.sendFeedback(new TranslationTextComponent("cmd.spreadplayers.success." + (p_241070_5_ ? "teams" : "entities"), aspreadplayerscommand$position.length, p_241070_1_.x, p_241070_1_.y, String.format(Locale.ROOT, "%.2f", d4)), true);
