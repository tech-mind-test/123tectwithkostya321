...
public class AttributeCommand
{
    ...
    {
        return new TranslationTextComponent("cmd.attribute.failed.entity", p_241011_0_);
    });
    ...
    {
        return new TranslationTextComponent("cmd.attribute.failed.no_attribute", p_241012_0_, p_241012_1_);
    });
    ...
    {
        return new TranslationTextComponent("cmd.attribute.failed.no_modifier", p_241017_1_, p_241017_0_, p_241017_2_);
    });
    ...
    {
        return new TranslationTextComponent("cmd.attribute.failed.modifier_already_present", p_241013_2_, p_241013_1_, p_241013_0_);
    });
    ...
    private static int func_241007_a_(CommandSource p_241007_0_, Entity p_241007_1_, Attribute p_241007_2_, double p_241007_3_) throws CommandSyntaxException
    {
        ...
        p_241007_0_.sendFeedback(new TranslationTextComponent("cmd.attribute.value.get.success", new TranslationTextComponent(p_241007_2_.getAttributeName()), p_241007_1_.getName(), d0), false);
    ...
    private static int func_241016_b_(CommandSource p_241016_0_, Entity p_241016_1_, Attribute p_241016_2_, double p_241016_3_) throws CommandSyntaxException
    {
        ...
        p_241016_0_.sendFeedback(new TranslationTextComponent("cmd.attribute.base_value.get.success", new TranslationTextComponent(p_241016_2_.getAttributeName()), p_241016_1_.getName(), d0), false);
    ...
    private static int func_241009_a_(CommandSource p_241009_0_, Entity p_241009_1_, Attribute p_241009_2_, UUID p_241009_3_, double p_241009_4_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            p_241009_0_.sendFeedback(new TranslationTextComponent("cmd.attribute.modifier.value.get.success", p_241009_3_, new TranslationTextComponent(p_241009_2_.getAttributeName()), p_241009_1_.getName(), d0), false);
    ...
    private static int func_241019_c_(CommandSource p_241019_0_, Entity p_241019_1_, Attribute p_241019_2_, double p_241019_3_) throws CommandSyntaxException
    {
        ...
        p_241019_0_.sendFeedback(new TranslationTextComponent("cmd.attribute.base_value.set.success", new TranslationTextComponent(p_241019_2_.getAttributeName()), p_241019_1_.getName(), p_241019_3_), false);
        return 1;
    }
    ...
    private static int func_241010_a_(CommandSource p_241010_0_, Entity p_241010_1_, Attribute p_241010_2_, UUID p_241010_3_, String p_241010_4_, double p_241010_5_, AttributeModifier.Operation p_241010_7_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            p_241010_0_.sendFeedback(new TranslationTextComponent("cmd.attribute.modifier.add.success", p_241010_3_, new TranslationTextComponent(p_241010_2_.getAttributeName()), p_241010_1_.getName()), false);
            return 1;
        }
    }
    ...
    private static int func_241008_a_(CommandSource p_241008_0_, Entity p_241008_1_, Attribute p_241008_2_, UUID p_241008_3_) throws CommandSyntaxException
    {
        ...
        {
            p_241008_0_.sendFeedback(new TranslationTextComponent("cmd.attribute.modifier.remove.success", p_241008_3_, new TranslationTextComponent(p_241008_2_.getAttributeName()), p_241008_1_.getName()), false);
            return 1;
        }
        else
        {
