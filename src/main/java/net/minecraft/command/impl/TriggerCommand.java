...
{
    private static final SimpleCommandExceptionType NOT_PRIMED = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.trigger.failed.unprimed"));
    private static final SimpleCommandExceptionType NOT_A_TRIGGER = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.trigger.failed.invalid"));
    ...
    private static int addToTrigger(CommandSource source, Score objective, int amount)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.trigger.add.success", objective.getObjective().func_197890_e(), amount), true);
    ...
    private static int setTrigger(CommandSource source, Score objective, int value)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.trigger.set.success", objective.getObjective().func_197890_e(), value), true);
        return value;
    }
    ...
    private static int incrementTrigger(CommandSource source, Score objectives)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.trigger.simple.success", objectives.getObjective().func_197890_e()), true);
