...
{
    private static final SimpleCommandExceptionType OVERLAP_EXCEPTION = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.clone.overlap"));
    ...
    {
        return new TranslationTextComponent("cmd.clone.toobig", p_208796_0_, p_208796_1_);
    });
