...
{
    private static final SimpleCommandExceptionType DUPLICATE_TEAM_NAME = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.add.duplicate"));
    private static final DynamicCommandExceptionType TEAM_NAME_TOO_LONG = new DynamicCommandExceptionType((p_208916_0_) ->
    {
        return new TranslationTextComponent("cmd.team.add.longName", p_208916_0_);
    });
    private static final SimpleCommandExceptionType EMPTY_NO_CHANGE = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.empty.unchanged"));
    private static final SimpleCommandExceptionType NAME_NO_CHANGE = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.name.unchanged"));
    private static final SimpleCommandExceptionType COLOR_NO_CHANGE = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.color.unchanged"));
    private static final SimpleCommandExceptionType FRIENDLY_FIRE_ALREADY_ON = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.friendlyfire.alreadyEnabled"));
    private static final SimpleCommandExceptionType FRIENDLY_FIRE_ALREADY_OFF = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.friendlyfire.alreadyDisabled"));
    private static final SimpleCommandExceptionType SEE_FRIENDLY_INVISIBLES_ALREADY_ON = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.seeFriendlyInvisibles.alreadyEnabled"));
    private static final SimpleCommandExceptionType SEE_FRIENDLY_INVISIBLES_ALREADY_OFF = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.seeFriendlyInvisibles.alreadyDisabled"));
    private static final SimpleCommandExceptionType NAMETAG_VISIBILITY_NO_CHANGE = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.nametagVisibility.unchanged"));
    private static final SimpleCommandExceptionType DEATH_MESSAGE_VISIBILITY_NO_CHANGE = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.deathMessageVisibility.unchanged"));
    private static final SimpleCommandExceptionType COLLISION_NO_CHANGE = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.team.option.collisionRule.unchanged"));
    ...
    private static int leaveFromTeams(CommandSource source, Collection<String> players)
    {
        ...
        if (players.size() == 1)
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.leave.success.single", players.iterator().next()), true);
        }
        else
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.leave.success.multiple", players.size()), true);
        }
    ...
    private static int joinTeam(CommandSource source, ScorePlayerTeam teamIn, Collection<String> players)
    {
        ...
        if (players.size() == 1)
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.join.success.single", players.iterator().next(), teamIn.func_237501_d_()), true);
        }
        else
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.join.success.multiple", players.size(), teamIn.func_237501_d_()), true);
        }
    ...
    private static int setNameTagVisibility(CommandSource source, ScorePlayerTeam teamIn, Team.Visible visibility) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.option.nametagVisibility.success", teamIn.func_237501_d_(), visibility.getDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int setDeathMessageVisibility(CommandSource source, ScorePlayerTeam teamIn, Team.Visible visibility) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.option.deathMessageVisibility.success", teamIn.func_237501_d_(), visibility.getDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int setCollisionRule(CommandSource source, ScorePlayerTeam teamIn, Team.CollisionRule rule) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.option.collisionRule.success", teamIn.func_237501_d_(), rule.getDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int setCanSeeFriendlyInvisibles(CommandSource source, ScorePlayerTeam teamIn, boolean value) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.option.seeFriendlyInvisibles." + (value ? "enabled" : "disabled"), teamIn.func_237501_d_()), true);
            return 0;
        }
    }
    ...
    private static int setAllowFriendlyFire(CommandSource source, ScorePlayerTeam teamIn, boolean value) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.option.friendlyfire." + (value ? "enabled" : "disabled"), teamIn.func_237501_d_()), true);
            return 0;
        }
    }
    ...
    private static int setDisplayName(CommandSource source, ScorePlayerTeam teamIn, ITextComponent value) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.option.name.success", teamIn.func_237501_d_()), true);
            return 0;
        }
    }
    ...
    private static int setColor(CommandSource source, ScorePlayerTeam teamIn, TextFormatting value) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.option.color.success", teamIn.func_237501_d_(), value.getFriendlyName()), true);
            return 0;
        }
    }
    ...
    private static int emptyTeam(CommandSource source, ScorePlayerTeam teamIn) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.empty.success", collection.size(), teamIn.func_237501_d_()), true);
    ...
    private static int removeTeam(CommandSource source, ScorePlayerTeam teamIn)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.team.remove.success", teamIn.func_237501_d_()), true);
    ...
    private static int addTeam(CommandSource source, String name, ITextComponent displayName) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            source.sendFeedback(new TranslationTextComponent("cmd.team.add.success", scoreplayerteam.func_237501_d_()), true);
            return scoreboard.getTeams().size();
        }
    }
    ...
    private static int listMembers(CommandSource source, ScorePlayerTeam teamIn)
    {
        ...
        if (collection.isEmpty())
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.list.members.empty", teamIn.func_237501_d_()), false);
        }
        else
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.list.members.success", teamIn.func_237501_d_(), collection.size(), TextComponentUtils.makeGreenSortedList(collection)), false);
        }
    ...
    private static int listTeams(CommandSource source)
    {
        ...
        if (collection.isEmpty())
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.list.teams.empty"), false);
        }
        else
        {
            source.sendFeedback(new TranslationTextComponent("cmd.team.list.teams.success", collection.size(), TextComponentUtils.func_240649_b_(collection, ScorePlayerTeam::func_237501_d_)), false);
        }
    ...
    private static int setPrefix(CommandSource source, ScorePlayerTeam teamIn, ITextComponent prefix)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.team.option.prefix.success", prefix), false);
        return 1;
    }
    ...
    private static int setSuffix(CommandSource source, ScorePlayerTeam teamIn, ITextComponent suffix)
    {
        ...
        source.sendFeedback(new TranslationTextComponent("cmd.team.option.suffix.success", suffix), false);
        return 1;
    }
}
