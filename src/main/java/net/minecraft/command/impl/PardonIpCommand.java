...
{
    private static final SimpleCommandExceptionType IP_INVALID_EXCEPTION = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.pardonip.invalid"));
    private static final SimpleCommandExceptionType FAILED_EXCEPTION = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.pardonip.failed"));
    ...
    private static int unbanIp(CommandSource source, String ipAddress) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                source.sendFeedback(new TranslationTextComponent("cmd.pardonip.success", ipAddress), true);
                return 1;
            }
        }
    }
