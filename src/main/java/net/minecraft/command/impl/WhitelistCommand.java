...
{
    private static final SimpleCommandExceptionType ALREADY_ON = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.whitelist.alreadyOn"));
    private static final SimpleCommandExceptionType ALREADY_OFF = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.whitelist.alreadyOff"));
    ...
    private static int listWhitelistedPlayers(CommandSource source)
    {
        ...
        if (astring.length == 0)
        {
            source.sendFeedback(new TranslationTextComponent("cmd.whitelist.none"), false);
        }
        else
        {
