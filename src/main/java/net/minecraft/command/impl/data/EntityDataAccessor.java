...
{
    private static final SimpleCommandExceptionType DATA_ENTITY_INVALID = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.data.entity.invalid"));
    ...
    {
        return new TranslationTextComponent("cmd.data.entity.modified", this.entity.getDisplayName());
    }
    ...
    {
        return new TranslationTextComponent("cmd.data.entity.query", this.entity.getDisplayName(), nbt.toFormattedComponent());
    }
    ...
    {
        return new TranslationTextComponent("cmd.data.entity.get", pathIn, this.entity.getDisplayName(), String.format(Locale.ROOT, "%.2f", scale), value);
    }
}
