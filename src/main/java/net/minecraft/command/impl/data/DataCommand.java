...
{
    private static final SimpleCommandExceptionType NOTHING_CHANGED = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.data.merge.failed"));
    private static final DynamicCommandExceptionType GET_INVALID_EXCEPTION = new DynamicCommandExceptionType((p_208922_0_) ->
    {
        return new TranslationTextComponent("cmd.data.get.invalid", p_208922_0_);
    });
    private static final DynamicCommandExceptionType GET_UNKNOWN_EXCEPTION = new DynamicCommandExceptionType((p_208919_0_) ->
    {
        return new TranslationTextComponent("cmd.data.get.unknown", p_208919_0_);
    });
    private static final SimpleCommandExceptionType field_218957_g = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.data.get.multiple"));
    private static final DynamicCommandExceptionType field_218958_h = new DynamicCommandExceptionType((p_218931_0_) ->
    {
        return new TranslationTextComponent("cmd.data.modify.expected_list", p_218931_0_);
    });
    private static final DynamicCommandExceptionType field_218959_i = new DynamicCommandExceptionType((p_218948_0_) ->
    {
        return new TranslationTextComponent("cmd.data.modify.expected_object", p_218948_0_);
    });
    private static final DynamicCommandExceptionType field_218960_j = new DynamicCommandExceptionType((p_218943_0_) ->
    {
        return new TranslationTextComponent("cmd.data.modify.invalid_index", p_218943_0_);
    });
