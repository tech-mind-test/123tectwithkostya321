...
{
    private static final SimpleCommandExceptionType DATA_BLOCK_INVALID_EXCEPTION = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.data.block.invalid"));
    ...
    {
        return new TranslationTextComponent("cmd.data.block.modified", this.pos.getX(), this.pos.getY(), this.pos.getZ());
    }
    ...
    {
        return new TranslationTextComponent("cmd.data.block.query", this.pos.getX(), this.pos.getY(), this.pos.getZ(), nbt.toFormattedComponent());
    }
    ...
    {
        return new TranslationTextComponent("cmd.data.block.get", pathIn, this.pos.getX(), this.pos.getY(), this.pos.getZ(), String.format(Locale.ROOT, "%.2f", scale), value);
    }
}
