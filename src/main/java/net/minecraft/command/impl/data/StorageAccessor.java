...
public class StorageAccessor implements IDataAccessor
{
    ...
    {
        return new TranslationTextComponent("cmd.data.storage.modified", this.field_229836_d_);
    }
    ...
    {
        return new TranslationTextComponent("cmd.data.storage.query", this.field_229836_d_, nbt.toFormattedComponent());
    }
    ...
    {
        return new TranslationTextComponent("cmd.data.storage.get", pathIn, this.field_229836_d_, String.format(Locale.ROOT, "%.2f", scale), value);
    }
}
