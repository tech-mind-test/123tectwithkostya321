...
{
    private static final SimpleCommandExceptionType field_218913_a = new SimpleCommandExceptionType(new TranslationTextComponent("cmd.schedule.same_tick"));
    private static final DynamicCommandExceptionType field_229811_b_ = new DynamicCommandExceptionType((p_229818_0_) ->
    {
        return new TranslationTextComponent("cmd.schedule.cleared.failure", p_229818_0_);
    });
    ...
    private static int func_241063_a_(CommandSource p_241063_0_, Pair<ResourceLocation, Either<FunctionObject, ITag<FunctionObject>>> p_241063_1_, int p_241063_2_, boolean p_241063_3_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            p_241063_1_.getSecond().ifLeft((p_229820_7_) ->
            {
                ...
                p_241063_0_.sendFeedback(new TranslationTextComponent("cmd.schedule.created.function", resourcelocation, p_241063_2_, i), true);
            }).ifRight((p_229819_7_) ->
            {
                String s = "#" + resourcelocation.toString();
                ...
                p_241063_0_.sendFeedback(new TranslationTextComponent("cmd.schedule.created.tag", resourcelocation, p_241063_2_, i), true);
            });
    ...
    private static int func_229817_a_(CommandSource p_229817_0_, String p_229817_1_) throws CommandSyntaxException
    {
        ...
        {
            p_229817_0_.sendFeedback(new TranslationTextComponent("cmd.schedule.cleared.success", i, p_229817_1_), true);
            return i;
        }
    }
}
