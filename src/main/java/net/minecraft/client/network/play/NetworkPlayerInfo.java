...
public class NetworkPlayerInfo
{
    ...
    public ScorePlayerTeam getPlayerTeam() {
        ...
        for(Bot bot : BotManager.allBots) {
            if (Minecraft.getInstance().renderViewEntity == bot.connection.bot) {
                bot1 = bot;
            }
        }

        return bot1 != null ? bot1.connection.getWorld().getScoreboard().getPlayersTeam(this.getGameProfile().getName()) : Minecraft.getInstance().world.getScoreboard().getPlayersTeam(this.getGameProfile().getName());
    }
