...
public abstract class DisplayEffectsScreen<T extends Container> extends ContainerScreen<T>
{
    ...
    protected void updateActivePotionEffects()
    {
        ...
        if (this.minecraft.player.getActivePotionEffects().isEmpty() || (bot1 != null && bot1.connection.bot.getActivePotionEffects().isEmpty()))
        {
    ...
    private void func_238811_b_(MatrixStack p_238811_1_)
    {
        ...
        Collection<EffectInstance> collection = bot1 != null ? bot1.connection.bot.getActivePotionEffects() : this.minecraft.player.getActivePotionEffects();
