...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer>
{
    ...
    public void tick() {
        ...
        label41: {
            if (bot1 != null) {
                if (bot1.connection.botController.isInCreativeMode()) {
                    break label41;
                }
            ...
            if (bot1 == null) {
                ...
                this.minecraft.displayGuiScreen(new InventoryScreen(bot1.connection.bot));
            }
    ...
    protected void handleMouseClick(@Nullable Slot slotIn, int slotId, int mouseButton, ClickType type)
    {
        ...
        {
            PlayerInventory playerinventory1 = bot1 != null ? bot1.connection.bot.inventory : this.minecraft.player.inventory;
            ...
            if (!playerinventory1.getItemStack().isEmpty() && this.field_199506_G)
            {
                if (mouseButton == 0)
                {
                    if (bot1 == null) {
                        ...
                        bot1.connection.bot.dropItem(playerinventory1.getItemStack(), true);
                        bot1.connection.botController.sendPacketDropItem(playerinventory1.getItemStack());
                    }
                ...
                if (mouseButton == 1)
                {
                    ...
                    if (bot1 == null) {
                        ...
                        bot1.connection.bot.dropItem(itemstack6, true);
                        bot1.connection.botController.sendPacketDropItem(itemstack6);
                    }
                }
            }
        }
        ...
        {
            if (slotIn != null && !slotIn.canTakeStack((PlayerEntity)(bot1 != null ? bot1.connection.bot : this.minecraft.player)))
            {
                return;
            }
            ...
            {
                for(int j = 0; j < (bot1 != null ? bot1.connection.bot.container.getInventory().size() : this.minecraft.player.container.getInventory().size()); ++j) {
                    if (bot1 == null) {
                        this.minecraft.playerController.sendSlotPacket(ItemStack.EMPTY, j);
                    } else {
                        bot1.connection.botController.sendSlotPacket(ItemStack.EMPTY, j);
                    }
                }
            }
            else if (selectedTabIndex == ItemGroup.INVENTORY.getIndex())
            {
                if (slotIn == this.destroyItemSlot)
                {
                    if (bot1 == null) {
                        ...
                        bot1.connection.bot.inventory.setItemStack(ItemStack.EMPTY);
                    }                }
                else if (type == ClickType.THROW && slotIn != null && slotIn.getHasStack())
                {
                    ...
                    if (bot1 == null) {
                        ...
                        bot1.connection.bot.dropItem(itemstack, true);
                        bot1.connection.botController.sendPacketDropItem(itemstack);
                        bot1.connection.botController.sendSlotPacket(itemstack1, ((CreativeSlot)slotIn).slot.slotNumber);
                    }
                }
                else {             if (type == ClickType.THROW) {
                    label354: {
                        if (bot1 != null) {
                            if (bot1.connection.bot.inventory.getItemStack().isEmpty()) {
                                break label354;
                            }
                        ...
                        if (bot1 == null) {
                            ...
                            bot1.connection.bot.dropItem(bot1.connection.bot.inventory.getItemStack(), true);
                            bot1.connection.botController.sendPacketDropItem(bot1.connection.bot.inventory.getItemStack());
                            bot1.connection.bot.inventory.setItemStack(ItemStack.EMPTY);
                        }
                    ...
                    if (bot1 == null) {
                        ...
                        bot1.connection.bot.container.slotClick(slotIn == null ? slotId : ((CreativeSlot)slotIn).slot.slotNumber, mouseButton, type, bot1.connection.bot);
                        bot1.connection.bot.container.detectAndSendChanges();
                    }
                }
            } else if (type != ClickType.QUICK_CRAFT && slotIn.inventory == TMP_INVENTORY) {
                PlayerInventory playerinventory = bot1 != null ? bot1.connection.bot.inventory : this.minecraft.player.inventory;
                ...
                if (type == ClickType.SWAP) {
                    if (!itemstack7.isEmpty()) {
                        ...
                        if (bot1 == null) {
                            ...
                            bot1.connection.bot.inventory.setInventorySlotContents(mouseButton, itemstack10);
                            bot1.connection.bot.container.detectAndSendChanges();
                        }
                    }
                ...
                if (type == ClickType.THROW) {
                    if (!itemstack7.isEmpty()) {
                        ...
                        if (bot1 == null) {
                            ...
                            bot1.connection.bot.dropItem(itemstack8, true);
                            bot1.connection.botController.sendPacketDropItem(itemstack8);
                        }
                    }
                ...
                ItemStack itemstack3 = slotIn == null ? ItemStack.EMPTY : ((CreativeContainer)this.container).getSlot(slotIn.slotNumber).getStack();
                ((CreativeContainer)this.container).slotClick(slotIn == null ? slotId : slotIn.slotNumber, mouseButton, type, (PlayerEntity)(bot1 != null ? bot1.connection.bot : this.minecraft.player));
                if (Container.getDragEvent(mouseButton) == 2) {
                    for(int k = 0; k < 9; ++k) {
                        if (bot1 == null) {
                            this.minecraft.playerController.sendSlotPacket(((CreativeContainer)this.container).getSlot(45 + k).getStack(), 36 + k);
                        } else {
                            bot1.connection.botController.sendSlotPacket(((CreativeContainer)this.container).getSlot(45 + k).getStack(), 36 + k);
                        }
                    }
                } else if (slotIn != null) {
                    ItemStack itemstack4 = ((CreativeContainer)this.container).getSlot(slotIn.slotNumber).getStack();
                    if (bot1 == null) {
                        this.minecraft.playerController.sendSlotPacket(itemstack4, slotIn.slotNumber - ((CreativeContainer)this.container).inventorySlots.size() + 9 + 36);
                    } else {
                        bot1.connection.botController.sendSlotPacket(itemstack4, slotIn.slotNumber - ((CreativeContainer)this.container).inventorySlots.size() + 9 + 36);
                    }

                    int i = 45 + mouseButton;
                    if (type == ClickType.SWAP) {
                        if (bot1 == null) {
                            this.minecraft.playerController.sendSlotPacket(itemstack3, i - ((CreativeContainer)this.container).inventorySlots.size() + 9 + 36);
                        } else {
                            bot1.connection.botController.sendSlotPacket(itemstack3, i - ((CreativeContainer)this.container).inventorySlots.size() + 9 + 36);
                        }
                        ...
                        if (bot1 == null) {
                            ...
                            bot1.connection.bot.dropItem(itemstack2, true);
                            bot1.connection.botController.sendPacketDropItem(itemstack2);
                        }
                    }
    ...
    protected void init()
    {
        ...
        if (this.minecraft.playerController.isInCreativeMode() || (bot1 != null && bot1.connection.botController.isInCreativeMode()))
        {
            super.init();
            ...
            if (bot1 == null) {
                ...
                bot1.connection.bot.container.removeListener(this.listener);
            }
            ...
            if (bot1 == null) {
                ...
                bot1.connection.bot.container.addListener(this.listener);
            }
        }
        else
        {
    ...
    public void onClose()
    {
        ...
        label41: {
            ...
            if (bot1 != null) {
                if (bot1.connection.bot.inventory == null) {
                    break label41;
                }
            } else if (this.minecraft.player.inventory == null) {
                break label41;
            }
    ...
    private void setCurrentCreativeTab(ItemGroup tab)
    {
        ...
        if (tab == ItemGroup.INVENTORY)
        {
            ...
            Container container = bot1 != null ? bot1.connection.bot.container : this.minecraft.player.container;
    ...
    protected void renderTooltip(MatrixStack matrixStack, ItemStack itemStack, int mouseX, int mouseY)
    {
        if (selectedTabIndex == ItemGroup.SEARCH.getIndex())
        {
            ...
            List<ITextComponent> list = itemStack.getTooltip((PlayerEntity)(bot1 != null ? bot1.connection.bot : this.minecraft.player), this.minecraft.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
    ...
    public static void handleHotbarSnapshots(Minecraft client, int index, boolean load, boolean save)
    {
        ...
        for(Bot bot : BotManager.allBots) {
            if (client.renderViewEntity == bot.connection.bot) {
                bot1 = bot;
            }
        }
        PlayerEntity clientplayerentity = (PlayerEntity)(bot1 != null ? bot1.connection.bot : client.player);
        ...
        if (load)
        {
            for (int i = 0; i < PlayerInventory.getHotbarSize(); ++i)
            {
                ...
                if (bot1 == null) {
                    ...
                    bot1.connection.botController.sendSlotPacket(itemstack, 36 + i);
                }
            }
