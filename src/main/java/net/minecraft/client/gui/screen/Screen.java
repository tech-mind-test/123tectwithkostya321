...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable, IGuiScreen {
    ...
    public boolean handleComponentClicked(@Nullable Style style) {
        if (style.getClickEvent() instanceof EventClientClick clientClickEvent) {
            ...
            String prefix = SkyCore.getInstance().getCommandsManager().getPrefix();
            CommandManager manager = SkyCore.getInstance().getCommandsManager();
            try {
    ...
    public void sendMessage(String text, boolean addToChat) {
        ...
        if (bot1 == null) {
            ...
            bot1.connection.bot.sendChatMessage(text);
        }
