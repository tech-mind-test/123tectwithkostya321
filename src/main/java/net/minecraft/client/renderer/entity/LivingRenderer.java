...
import sky.core.modules.impl.visuals.SeeInvisibles;
...
public abstract class LivingRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements IEntityRenderer<T, M> {
    ...
    public void render(T entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entityIn, this, partialTicks, matrixStackIn, bufferIn, packedLightIn)) {
            ...
            for(Bot bot : BotManager.allBots) {
                if (minecraft.renderViewEntity == bot.connection.bot) {
                    bot1 = bot;
                }
            }
            boolean flag1 = this.isVisible(entityIn);
            boolean flag2 = !flag1 && !entityIn.isInvisibleToPlayer((PlayerEntity)(bot1 != null ? bot1.connection.bot : minecraft.player));
            ...
            if (rendertype != null) {
                ...
                SeeInvisibles module = (SeeInvisibles) SkyCore.getInstance().getModuleManager().getModule(SeeInvisibles.class);
    ...
    protected boolean canRenderName(T entity)
    {
        ...
        else
        {
            ...
            boolean flag = !entity.isInvisibleToPlayer((PlayerEntity)(bot1 != null ? bot1.connection.bot : clientplayerentity));
            if (entity != (bot1 != null ? bot1.connection.bot : clientplayerentity)) {
                Team team = entity.getTeam();
                Team team1 = ((AbstractClientPlayerEntity)(bot1 != null ? bot1.connection.bot : clientplayerentity)).getTeam();
                if (team != null)
                {
