...
public class PlayerRenderer extends LivingRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>>
{
    ...
    public ResourceLocation getEntityTexture(AbstractClientPlayerEntity entity)
    {
        ...
        boolean isFriend = SkyCore.getInstance().getFriendManager().isFriend(entity.getName().getString());
        ...
        if (shouldUseCustomModel) {
            if (customModels.models.is("Crazy Rabbit")) {
                return new ResourceLocation("minecraft", "SkyCore/models/rabbit.png");
            } else if (customModels.models.is("Freddy Bear")) {
                return new ResourceLocation("minecraft", "SkyCore/models/freddy.png");
            } else if (customModels.models.is("White Demon")) {
                return new ResourceLocation("minecraft", "SkyCore/models/whitedemon.png");
            } else if (customModels.models.is("Red Demon")) {
                return new ResourceLocation("minecraft", "SkyCore/models/reddemon.png");
            } else if (customModels.models.is("Amogus")) {
                return new ResourceLocation("minecraft", "SkyCore/models/amogus.png");
            }
        }
