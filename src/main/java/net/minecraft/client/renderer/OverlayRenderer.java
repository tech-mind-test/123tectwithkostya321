...
public class OverlayRenderer {
    ...
    public static void renderOverlays(Minecraft minecraftIn, MatrixStack matrixStackIn) {
        ...
        PlayerEntity playerentity = (PlayerEntity) (bot1 != null ? bot1.connection.bot : minecraftIn.player);
        ...
        if (!minecraftIn.player.isSpectator() || (bot1 != null && !bot1.connection.bot.isInvisible())) {
            ...
            if ((minecraftIn.player.isBurning() || (bot1 != null && bot1.connection.bot.isBurning()))) {
    ...
    private static void renderUnderwater(Minecraft minecraftIn, MatrixStack matrixStackIn)
    {
        ...
        if (!Config.isShaders() || Shaders.isUnderwaterOverlay())
        {
            ...
            float f = bot1 != null ? bot1.connection.bot.getBrightness() : minecraftIn.player.getBrightness();
            ...
            float f5 = 1.0F;
            float f6 = -0.5F;
            float f7 = bot1 != null ? -bot1.connection.bot.rotationYaw / 64.0F : -minecraftIn.player.rotationYaw / 64.0F;
            float f8 = bot1 != null ? bot1.connection.bot.rotationPitch / 64.0F : minecraftIn.player.rotationPitch / 64.0F;
            Matrix4f matrix4f = matrixStackIn.getLast().getMatrix();
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_COLOR_TEX);
