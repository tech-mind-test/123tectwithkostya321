...
public abstract class AbstractClientPlayerEntity extends PlayerEntity implements CapeHolder
{
    ...
    public final World worldClient;
    ...
    public AbstractClientPlayerEntity(BotWorld world, GameProfile profile) {
        super(world, world.func_239140_u_(), world.func_243489_v(), profile);
        this.worldClient = world;
        this.nameClear = profile.getName();
        if (this.nameClear != null && !this.nameClear.isEmpty()) {
    ...
    public boolean isSpectator() {
        if (Minecraft.getInstance().getConnection() == null) {
            ...
            NetworkPlayerInfo var10000;
            if (this instanceof BotPlayer) {
                BotPlayer b = (BotPlayer)this;
                var10000 = b.connection.getPlayerInfo(this.getGameProfile().getId());
            } else {
                var10000 = Minecraft.getInstance().getConnection().getPlayerInfo(this.getGameProfile().getId());
            }

            NetworkPlayerInfo networkplayerinfo = var10000;
    ...
    protected NetworkPlayerInfo getPlayerInfo() {
        if (Minecraft.getInstance().getConnection() == null) {
            ...
            if (this.playerInfo == null) {
                NetworkPlayerInfo var10001;
                if (this instanceof BotPlayer) {
                    BotPlayer b = (BotPlayer)this;
                    var10001 = b.connection.getPlayerInfo(this.getUniqueID());
                } else {
                    var10001 = Minecraft.getInstance().getConnection().getPlayerInfo(this.getUniqueID());
                }

                this.playerInfo = var10001;
            }
    ...
    private static final ResourceLocation CAPE_LOCATION = new ResourceLocation("SkyCore/cape/cape.png");
