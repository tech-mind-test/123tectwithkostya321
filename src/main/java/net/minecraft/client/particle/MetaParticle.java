...
{
    protected MetaParticle(World world, double x, double y, double z)
    {
        super(world, x, y, z);
    }

    protected MetaParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
