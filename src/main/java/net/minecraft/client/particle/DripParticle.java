...
public class DripParticle extends SpriteTexturedParticle
{
    ...
    private DripParticle(World world, double x, double y, double z, Fluid fluid)
    {
        super(world, x, y, z);
    ...
    {
        private DrippingLava(World world, double x, double y, double z, Fluid fluid, IParticleData particleData)
        {
    ...
    {
        private FallingHoneyParticle(World world, double x, double y, double z, Fluid fluid, IParticleData particleData)
        {
            super(world, x, y, z, fluid, particleData);
        }
    ...
    static class FallingLiquidParticle extends DripParticle.FallingNectarParticle
    {
        ...
        private FallingLiquidParticle(World world, double x, double y, double z, Fluid fluid, IParticleData particleData)
        {
            super(world, x, y, z, fluid);
            this.particleData = particleData;
        }
    ...
    {
        private FallingNectarParticle(World world, double x, double y, double z, Fluid fluid)
        {
            super(world, x, y, z, fluid);
