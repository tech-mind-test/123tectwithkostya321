...
public class RedstoneParticle extends SpriteTexturedParticle
{
    ...
    private RedstoneParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ, RedstoneParticleData particleData, IAnimatedSprite spriteWithAge)
    {
