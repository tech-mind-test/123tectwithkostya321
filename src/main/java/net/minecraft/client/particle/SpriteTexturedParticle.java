...
public abstract class SpriteTexturedParticle extends TexturedParticle
{
    ...
    protected SpriteTexturedParticle(World world, double x, double y, double z)
    {
        super(world, x, y, z);
    }

    protected SpriteTexturedParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
