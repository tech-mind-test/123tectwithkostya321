...
public class SpellParticle extends SpriteTexturedParticle
{
    ...
    private SpellParticle(World p_i232429_1_, double x, double y, double z, double p_i232429_8_, double motionY, double p_i232429_12_, IAnimatedSprite spriteWithAge)
    {
