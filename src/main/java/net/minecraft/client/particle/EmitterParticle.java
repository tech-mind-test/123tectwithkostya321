...
public class EmitterParticle extends MetaParticle
{
    ...
    public EmitterParticle(World world, Entity entity, IParticleData particleData)
    {
        this(world, entity, particleData, 3);
    }

    public EmitterParticle(World world, Entity entity, IParticleData particleData, int lifetime)
    {
        this(world, entity, particleData, lifetime, entity.getMotion());
    }

    private EmitterParticle(World world, Entity entity, IParticleData particleData, int lifetime, Vector3d motionVector)
    {
