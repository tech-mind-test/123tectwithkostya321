...
{
    private UnderwaterParticle(World world, double x, double y, double z)
    {
    ...
    private UnderwaterParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
