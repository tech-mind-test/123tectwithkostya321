...
public class BreakingParticle extends SpriteTexturedParticle
{
    ...
    private BreakingParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ, ItemStack stack)
    {
    ...
    protected BreakingParticle(World world, double x, double y, double z, ItemStack stack)
    {
