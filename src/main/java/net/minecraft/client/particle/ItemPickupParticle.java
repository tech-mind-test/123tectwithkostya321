...
public class ItemPickupParticle extends Particle
{
    ...
    public ItemPickupParticle(EntityRendererManager entityRenderManager, RenderTypeBuffers buffers, BotWorld world, Entity item, Entity target) {
        this(entityRenderManager, buffers, world, item, target, item.getMotion());
    }
    ...
    private ItemPickupParticle(EntityRendererManager entityRenderManager, RenderTypeBuffers buffers, BotWorld world, Entity item, Entity target, Vector3d motionVector) {
        super(world, item.getPosX(), item.getPosY(), item.getPosZ(), motionVector.x, motionVector.y, motionVector.z);
        this.renderTypeBuffers = buffers;
        this.item = this.func_239181_a_(item);
        this.target = target;
