...
public abstract class TexturedParticle extends Particle
{
    ...
    protected TexturedParticle(World world, double x, double y, double z)
    {
        super(world, x, y, z);
    }

    protected TexturedParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
