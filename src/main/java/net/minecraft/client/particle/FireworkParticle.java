...
public class FireworkParticle
{
    ...
    {
        private Overlay(World world, double x, double y, double z)
        {
            super(world, x, y, z);
            this.maxAge = 4;
        }
    ...
    static class Spark extends SimpleAnimatedParticle
    {
        ...
        private Spark(World world, double x, double y, double z, double motionX, double motionY, double motionZ, ParticleManager particleManager, IAnimatedSprite spriteWithAge)
        {
    ...
    public static class Starter extends MetaParticle
    {
        ...
        public Starter(World world, double x, double y, double z, double motionX, double motionY, double motionZ, ParticleManager particleManager, @Nullable CompoundNBT p_i232391_15_)
        {
            super(world, x, y, z);
            this.motionX = motionX;
            this.motionY = motionY;
