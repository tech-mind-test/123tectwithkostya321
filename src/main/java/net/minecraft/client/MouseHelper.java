        ...
        if (handle == this.minecraft.getMainWindow().getHandle()) {
            ...
            if (!aboolean[0] && (this.minecraft.currentScreen == null || this.minecraft.currentScreen.passEvents) && this.minecraft.loadingGui == null) {
                ...
                if (flag) {
                    ...
                    if (this.minecraft.player.isSpectator() || ((bot1 != null) && (!bot1.connection.bot.isSpectator()))) {
        ...
        if (handle == Minecraft.getInstance().getMainWindow().getHandle()) {
            ...
            if (this.minecraft.loadingGui == null) {
                if (this.minecraft.currentScreen != null) {
                    ...
                    if (this.accumulatedScrollDelta != (double) 0.0F && Math.signum(d0) != Math.signum(this.accumulatedScrollDelta)) {
                        this.accumulatedScrollDelta = (double) 0.0F;
                    }
                    ...
                    label90:
                    {
                        ...
                        if (bot1 != null) {
                            if (!bot1.connection.bot.isSwingInProgress) {
                                break label90;
                            }
                        ...
                        if (this.minecraft.ingameGUI.getSpectatorGui().isMenuActive()) {
                            ...
                            float f = MathHelper.clamp(bot1 != null ? bot1.connection.bot.abilities.getFlySpeed() + f1 * 0.005F : this.minecraft.player.abilities.getFlySpeed() + f1 * 0.005F, 0.0F, 0.2F);
                            if (bot1 == null) {
                                this.minecraft.player.abilities.setFlySpeed(f);
                            } else {
                                bot1.connection.bot.abilities.setFlySpeed(f);
                            }
                    ...
                    if (bot1 == null) {
                        ...
                        bot1.connection.bot.inventory.changeCurrentItem((double) f1);
                    }
                }
            }
        }
    ...
    public void updatePlayerLook() {
        ...
        if (this.isMouseGrabbed() && this.minecraft.isGameFocused()) {
            ...
            for (Bot bot : BotManager.allBots) {
                if (this.minecraft.renderViewEntity == bot.connection.bot) {
                    bot1 = bot;
                    bot.connection.bot.rotateTowards(d2, d3 * (double) i);
                }
            }
            if (bot1 == null && this.minecraft.player != null) {
