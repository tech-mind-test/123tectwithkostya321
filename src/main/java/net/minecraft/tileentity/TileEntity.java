...
public abstract class TileEntity
{
    ...
    /**
     * Checks if players can use this tile entity to access operator (permission level 2) cmd either directly or
     ...
     * accessible.</p>@return true if this block entity offers ways for unauthorized players to use restricted cmd
     */
