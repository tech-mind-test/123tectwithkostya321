...
public abstract class AbstractBlock {
    ...
    public abstract static class AbstractBlockState extends StateHolder<Block, BlockState> {
        ...
        public VoxelShape getRayShape(IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
            return SkyCore.getInstance().getModuleManager().getOpenWalls().isEnabled() && SkyCore.getInstance().getModuleManager().getOpenWalls().getBlockClasses().stream().noneMatch((clazz) -> clazz.isInstance(this.getBlock())) ? VoxelShapes.empty() : this.getBlock().getShape(this.getSelf(), worldIn, pos, context);
        }
