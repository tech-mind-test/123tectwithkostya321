...
public class ParticleTypes
{
    ...
    public static final BasicParticleType PARTICULAR_WATER_SPLASH_EMITTER = register("particular_water_splash_emitter", true);
    public static final BasicParticleType PARTICULAR_WATER_SPLASH = register("particular_water_splash", true);
    public static final BasicParticleType PARTICULAR_WATER_SPLASH_FOAM = register("particular_water_splash_foam", true);
    public static final BasicParticleType PARTICULAR_WATER_SPLASH_RING = register("particular_water_splash_ring", true);
    public static final BasicParticleType MASEFFECT_REVIVE = register("maseffect_revive", true);
    public static final BasicParticleType MASEFFECT_REVIVE_SPARK = register("maseffect_revive_spark", true);
