...
{
    public static Iterator<ChunkRenderDispatcher.ChunkRender> makeShadowChunkIterator(World world, double partialTicks, Entity viewEntity, int renderDistanceChunks, ViewFrustum viewFrustum)
    {
