            ...
            if (nightvision && i < 64) {
                ...
                if (j < 16) {
                    ...
                    if (world instanceof ClientWorld) {
                        ...
                        f = 1.1666666F * (w.getSunBrightness(1.0F) - 0.2F);
                        flag2 = w.getTimeLightningFlash() > 0;
                    }

                    if (world instanceof BotWorld) {
                    ...
                    float f3 = Config.limitTo1(FullBright.getGammaForRendering((float) Config.getGameSettings().gamma));
