...
public class DynamicLights
{
    ...
    {
        World clientworld = renderGlobal.getWorld();
        ClientWorld clw = null;
        BotWorld btw = null;
        if (clientworld instanceof ClientWorld w) {
            clw = w;
        }

        if (clientworld instanceof BotWorld w) {
            btw = w;
        }

        if (clientworld != null) {
            for (Entity entity : clw != null ? clw.getAllEntities() : btw.getAllEntities())
            {
