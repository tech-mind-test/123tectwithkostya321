/* Decompiler 413ms, total 855ms, lines 1042 */
package other.bot.world;
...
import net.minecraft.client.particle.FireworkParticle.Starter;
...
import other.bot.player.BotControllerOF;
...
public class BotWorld extends World {
    ...
    private final BotWorld.ClientWorldInfo field_239130_d_;
    ...
    protected ClientChunkProvider field_239129_E_;
    ...
    public BotWorld(BotClientPlayNetHandler p_i242067_1_, BotWorld.ClientWorldInfo p_i242067_2_, RegistryKey<World> p_i242067_3_, DimensionType p_i242067_4_, int p_i242067_5_, Supplier<IProfiler> p_i242067_6_, WorldRenderer p_i242067_7_, boolean p_i242067_8_, long p_i242067_9_) {
    ...
    public void setDayTime(long time) {
        if (time < 0L) {
            time = -time;
            ((BooleanValue)this.getGameRules().get(GameRules.DO_DAYLIGHT_CYCLE)).set(false, (MinecraftServer)null);
        } else {
            ((BooleanValue)this.getGameRules().get(GameRules.DO_DAYLIGHT_CYCLE)).set(true, (MinecraftServer)null);
        }
    ...
    private void removeEntity(Entity entityIn) {
        ...
        if (Reflector.EntityLeaveWorldEvent_Constructor.exists()) {
            Reflector.postForgeBusEvent(Reflector.EntityLeaveWorldEvent_Constructor, new Object[]{entityIn, this});
        }
    ...
    public void animateTick(int x, int y, int z, int offset, Random random, boolean holdingBarrier, Mutable pos) {
    ...
    private void spawnFluidParticle(BlockPos blockPosIn, BlockState blockStateIn, IParticleData particleDataIn, boolean shapeDownSolid) {
        if (blockStateIn.getFluidState().isEmpty()) {
            ...
            double d0 = voxelshape.getEnd(Axis.Y);
            if (d0 < 1.0D) {
                if (shapeDownSolid) {
                ...
                double d1 = voxelshape.getStart(Axis.Y);
                if (d1 > 0.0D) {
                    ...
                    double d2 = voxelshape1.getEnd(Axis.Y);
    ...
    private void spawnParticle(BlockPos posIn, IParticleData particleDataIn, VoxelShape voxelShapeIn, double y) {
        this.spawnParticle((double)posIn.getX() + voxelShapeIn.getStart(Axis.X), (double)posIn.getX() + voxelShapeIn.getEnd(Axis.X), (double)posIn.getZ() + voxelShapeIn.getStart(Axis.Z), (double)posIn.getZ() + voxelShapeIn.getEnd(Axis.Z), y, particleDataIn);
    }
    ...
    public void playSound(@Nullable PlayerEntity player, double x, double y, double z, SoundEvent soundIn, SoundCategory category, float volume, float pitch) {
        if (Reflector.ForgeEventFactory_onPlaySoundAtEntity.exists()) {
            Object object = Reflector.ForgeEventFactory_onPlaySoundAtEntity.call(new Object[]{player, soundIn, category, volume, pitch});
            ...
            category = (SoundCategory)Reflector.call(object, Reflector.PlaySoundAtEntityEvent_getCategory, new Object[0]);
    ...
    public void playMovingSound(@Nullable PlayerEntity playerIn, Entity entityIn, SoundEvent eventIn, SoundCategory categoryIn, float volume, float pitch) {
        if (Reflector.ForgeEventFactory_onPlaySoundAtEntity.exists()) {
            Object object = Reflector.ForgeEventFactory_onPlaySoundAtEntity.call(new Object[]{playerIn, eventIn, categoryIn, volume, pitch});
            if (Reflector.callBoolean(object, Reflector.Event_isCanceled, new Object[0]) || Reflector.call(object, Reflector.PlaySoundAtEntityEvent_getSound, new Object[0]) == null) {
                return;
            }

            eventIn = (SoundEvent)Reflector.call(object, Reflector.PlaySoundAtEntityEvent_getSound, new Object[0]);
            categoryIn = (SoundCategory)Reflector.call(object, Reflector.PlaySoundAtEntityEvent_getCategory, new Object[0]);
            volume = Reflector.callFloat(object, Reflector.PlaySoundAtEntityEvent_getVolume, new Object[0]);
        }
    ...
    public void makeFireworks(double x, double y, double z, double motionX, double motionY, double motionZ, @Nullable CompoundNBT compound) {
        this.mc.particles.addEffect(new Starter(this, x, y, z, motionX, motionY, motionZ, this.mc.particles, compound));
    }
    ...
    public int getBlockColorRaw(BlockPos blockPosIn, ColorResolver colorResolverIn) {
        ...
        if (i == 0) {
            ...
            int j1;
            for(Mutable blockpos$mutable = new Mutable(); cubecoordinateiterator.hasNext(); i1 += j1 & 255) {
    ...
    public BlockPos func_239140_u_() {
        ...
        if (!this.getWorldBorder().contains(blockpos)) {
            blockpos = this.getHeight(Type.MOTION_BLOCKING, new BlockPos(this.getWorldBorder().getCenterX(), 0.0D, this.getWorldBorder().getCenterZ()));
        }
    ...
    public BotWorld.ClientWorldInfo getWorldInfo() {
        return this.field_239130_d_;
    }

    // $FF: synthetic method
    // $FF: bridge method
    public IWorldInfo getWorldInfo1() {
        return this.getWorldInfo();
    }

    // $FF: synthetic method
    // $FF: bridge method
    public AbstractChunkProvider getChunkProvider1() {
