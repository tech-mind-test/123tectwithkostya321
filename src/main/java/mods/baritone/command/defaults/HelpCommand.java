...
public class HelpCommand extends Command {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (!args.hasAny() || args.is(Integer.class)) {
            Paginator.paginate(
                    ...
                    () -> logDirect("All Baritone cmd (clickable):"),
                    command -> {
    ...
    public String getShortDesc() {
        return "View all cmd or help on specific ones";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "Using this command, you can view detailed help information on how to use certain cmd of Baritone.",
                "",
                "Usage:",
                "> help - Lists all cmd and their short descriptions.",
