...
public class SelCommand extends Command {
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                ...
                "",
                "The expand/contract/shift cmd use a kind of selector to choose which selections to target. Supported ones are a/all, n/newest, and o/oldest.",
                "",
                "Usage:",
