...
public final class Settings {
    ...
    /**
     * Whether or not to allow you to run Baritone cmd with the prefix
     */
    ...
    /**
     * Echo cmd to chat when they are run
     */
    ...
    /**
     * Censor arguments to ran cmd, to hide, for example, coordinates to #goal
     */
    ...
    /**
     * EventTarget builder's behavior to not attempt to correct blocks that are currently water
     */
